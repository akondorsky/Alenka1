object ClientEdit_F: TClientEdit_F
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = #1056#1077#1076#1072#1082#1090#1080#1088#1086#1074#1072#1085#1080#1077' '#1079#1072#1082#1072#1079#1095#1080#1082#1072'.'
  ClientHeight = 457
  ClientWidth = 457
  Color = clBtnFace
